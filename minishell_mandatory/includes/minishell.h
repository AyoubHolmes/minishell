...
int				add_simple_cmd_node(t_simple_cmd **simple_cmd, char *cmd,
					t_minishell *cli);
...
void			ft_lexer_token_helper(char *c, char *line,
					int setter, int token);
